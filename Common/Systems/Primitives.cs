...
public sealed class PrimitiveDrawing : ILoadable
{
    ...
    public static void DrawPrimitiveStrip2(List<Vector2> vertices, List<Color> colors, Texture2D sprite = null, List<Vector2> texcoords = null, bool add = false, Effect eff = null)
    {
        Main.spriteBatch.End();
        ...
        effect.World = Matrix.CreateTranslation(0f, 0f, 0f);
        effect.Projection = Matrix.CreateOrthographicOffCenter(0f, Main.screenWidth, Main.screenHeight, 0f, -1f, 1f);
        ...
        Main.spriteBatch.End();
        Main.spriteBatch.Begin(SpriteSortMode.Immediate, add ? BlendState.Additive : BlendState.AlphaBlend, Main.DefaultSamplerState, null, null, null);
    ...
    public static void DrawPrimitiveStrip2(List<Vector2> vertices, List<Color> colors, Vector2 targetSize, Texture2D sprite = null, List<Vector2> texcoords = null, bool add = false, Effect eff = null)
    {
        Main.spriteBatch.End();
        Main.spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend, null, null, null, eff, Main.GameViewMatrix.TransformationMatrix);
        ...
        effect.World = Matrix.CreateTranslation(0f, 0f, 0f);
        effect.Projection = Matrix.CreateOrthographicOffCenter(0f, targetSize.X, targetSize.Y, 0f, -1f, 1f);
