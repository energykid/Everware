...
public class CthulhuBloodParticle : Particle
{
    ...
    {
        var BloodEffect = AssetReferences.Content.PreHardmode.EyeOfCthulhuRework.CthulhuBlood.CreateBloodEffect();

        var asset = AssetReferences.Content.PreHardmode.EyeOfCthulhuRework.EyeOfCthulhu_BloodMask.Asset;
        ...
        PixelRendering.DrawPixelatedSprite(asset.Value,
            ...
            {
                BloodEffect.Parameters.BloodGradient = AssetReferences.Content.PreHardmode.EyeOfCthulhuRework.BloodPalette.Asset.Value;
