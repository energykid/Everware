...
public class EyeOfCthulhu : GlobalNPC
{
        ...
        switch (CurrentAttack)
        {
            ...
            case AttackState.Phase2Transition:
                ...
                if (AttackTimer == 0)
                {
                    ...
                    SoundEngine.PlaySound(Sounds.NPC.EoCMuffledRoar.Asset with { Pitch = -0.5f }, npc.Center);
                }
                ...
                if (AttackTimer < 180)
                {
                    ...
                    {
                        TendrilSplay += 0.4f;
                        SoundEngine.PlaySound(Sounds.NPC.EoCTendrilEmerge.Asset with { Pitch = Easing.KeyFloat(AttackTimer, 0, 100, 0.2f, 0.6f, Easing.Linear) }, npc.Center);
                ...
                else
                {
                    ...
                    if (AttackTimer == 180)
                    {
                        SoundEngine.PlaySound(Sounds.NPC.EoCTendrilEmerge.Asset with { Pitch = -0.2f }, npc.Center);
                ...
                else
                {
                    ...
                    if (AttackTimer < Delay + 32)
                    {
                        ...
                        if (AttackTimer % 8 >= 2 && AttackTimer % 15 < 9)
                        {
                            ...
                            if (AttackTimer % 8 == 2)
                            {
                                SoundEngine.PlaySound(Sounds.NPC.EoCStab.Asset, TendrilClawPositions[i]);
    ...
    public override bool PreDraw(NPC npc, SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
    {
        ...
        if (Phase > 0)
        {
            EyeDraw = AssetReferences.Content.PreHardmode.EyeOfCthulhuRework.EyeOfCthulhuPhase2.Asset;
            if (Roar > 0.1f) EyeDraw = AssetReferences.Content.PreHardmode.EyeOfCthulhuRework.EyeOfCthulhuRoaring.Asset;
        }
    ...
    {
        Roar = 1f;
        SoundEngine.PlaySound(Sounds.NPC.EnhancedEoCRoar.Asset, npc.Center);
    }
