...
{
    public override string Texture => "Everware/Assets/Textures/Quarry/Rebuker";
    public static readonly SoundStyle LoadSound = Assets.Sounds.Gear.Weapon.RebukerLoad.Asset with { PitchRange = (-0.2f, 0.2f) };
    public static readonly SoundStyle FireSound = Assets.Sounds.Gear.Weapon.RebukerFire.Asset with { PitchRange = (-0.2f, 0.2f) };
...
{
    public override string Texture => "Everware/Assets/Textures/Quarry/RebukerBolt";
    bool HasHit = false;
    int HitTimer = 0;
    int NumberOfHits = 0;
    public override void SetDefaults()
