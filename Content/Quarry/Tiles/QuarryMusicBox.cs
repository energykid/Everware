...
public class QuarryMusicBox : EverItem
{
    public override string Texture => "Everware/Assets/Textures/Quarry/QuarryMusicBox";
    public override void SetStaticDefaults()
    {
        ...
        MusicLoader.AddMusicBox(Mod, Assets.Sounds.Music.Quarry.Slot, ModContent.ItemType<QuarryMusicBox>(), ModContent.TileType<QuarryMusicBoxPlaced>());
    }

    public override void SetDefaults()
    {
        Item.DefaultToMusicBox(ModContent.TileType<QuarryMusicBoxPlaced>(), 0);
    }
}

public class QuarryMusicBoxPlaced : ModTile
{
    public override string Texture => "Everware/Assets/Textures/Quarry/QuarryMusicBoxPlaced";
    public override void SetStaticDefaults()
    {
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<QuarryMusicBox>();
    }
