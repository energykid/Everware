...
public class Kilnpost : EverWeaponItem
{
    ...
    public static readonly SoundStyle ThrustSound = Assets.Sounds.Gear.Weapon.KilnpostThrust.Asset with { PitchRange = (-0.2f, 0.2f) };
    public static readonly SoundStyle BreakawaySound = Assets.Sounds.Gear.Weapon.KilnpostBreakaway.Asset with { PitchRange = (-0.2f, 0.2f) };
...
public class KilnpostHoldout : EverHoldoutProjectile
{
    ...
    public static readonly Asset<Texture2D> BrokenAsset = Assets.Textures.Kiln.Kilnpost_Broken.Asset;
...
{
    public override string Texture => "Everware/Assets/Textures/Kiln/KilnpostBreakaway";
