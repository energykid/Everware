...
public class KilnMusicBox : EverItem
{
    public override string Texture => "Everware/Assets/Textures/Kiln/KilnMusicBox";
    public override void SetStaticDefaults()
    {
        ...
        MusicLoader.AddMusicBox(Mod, Assets.Sounds.Music.Kiln.Slot, ModContent.ItemType<KilnMusicBox>(), ModContent.TileType<KilnMusicBoxPlaced>());
    }

    public override void SetDefaults()
    {
        Item.DefaultToMusicBox(ModContent.TileType<KilnMusicBoxPlaced>(), 0);
    }
}

public class KilnMusicBoxPlaced : ModTile
{
    public override string Texture => "Everware/Assets/Textures/Kiln/KilnMusicBoxPlaced";
    public override void SetStaticDefaults()
    {
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<KilnMusicBox>();
    }
