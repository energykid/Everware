...
{
    public override string Texture => "Everware/Assets/Textures/Kiln/KilnPowderDust";
}
public class RawKilnPowderDust : PowderDust
{
    public override string Texture => "Everware/Assets/Textures/Kiln/RawKilnPowderDust";
}