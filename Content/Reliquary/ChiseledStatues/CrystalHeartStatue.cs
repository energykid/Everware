...
public class CrystalHeartStatueItem : EverStatueItem
{
    ...
    public override int UpgradeMaterial => ItemID.LifeCrystal;
}
...
public class PowerHeart : EverPickupItem
{
    ...
    public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
    {
        ...
        spriteBatch.Draw(Glow.Value, Item.Center - Main.screenPosition, Glow.Frame(), new Color(65, 0, 25, 0), 0f, Glow.Size() / 2f, s * 0.5f, SpriteEffects.None, 0f);
