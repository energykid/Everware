...
{
    public class EverwareBackgroundStyle : ModSurfaceBackgroundStyle
    {
        ...
        public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.End();
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.LinearClamp, null, Main.Rasterizer, null, Main.UIScaleMatrix);
            ...
            */
            ...
            spriteBatch.End();
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.Additive, SamplerState.LinearClamp, null, Main.Rasterizer, Effect2.Shader, Main.BackgroundViewMatrix.TransformationMatrix);
            ...
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.LinearClamp, null, Main.Rasterizer, Effect.Shader, Main.BackgroundViewMatrix.TransformationMatrix);

            Main.spriteBatch.Draw(Mist.Value, Vector2.Zero - new Vector2(20, 20) + (Parallax * 20), Mist.Frame(), MistColorForeground, 0f, Vector2.Zero, Vector2.One, SpriteEffects.None, 0f);

            spriteBatch.End();
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.Additive, SamplerState.LinearClamp, null, Main.Rasterizer, null, Main.BackgroundViewMatrix.TransformationMatrix);
    ...
    public static EverwareBackgroundStyle style = new();
    public override ModSurfaceBackgroundStyle MenuBackgroundStyle => ModContent.GetInstance<EverwareBackgroundStyle>();
    public override bool PreDrawLogo(SpriteBatch spriteBatch, ref Vector2 logoDrawCenter, ref float logoRotation, ref float logoScale, ref Color drawColor)
    {
        ...
        spriteBatch.End();
        spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.Additive, SamplerState.LinearClamp, null, Main.Rasterizer, null, Main.UIScaleMatrix);
        ...
        spriteBatch.End();
        spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, null, Main.Rasterizer, LogoEffect.Shader, Main.UIScaleMatrix);
