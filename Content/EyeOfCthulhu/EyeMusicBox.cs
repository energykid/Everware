...
namespace Everware.Content.EyeOfCthulhuRework.Tiles;

public class EyeMusicBox : EverItem
{
    public override string Texture => "Everware/Assets/Textures/EyeOfCthulhu/EyeMusicBox";
    public override void SetStaticDefaults()
    {
        ...
        MusicLoader.AddMusicBox(Mod, Assets.Sounds.Music.EyeOfCthulhu.Slot, ModContent.ItemType<EyeMusicBox>(), ModContent.TileType<EyeMusicBoxPlaced>());
    }

    public override void SetDefaults()
    {
        Item.DefaultToMusicBox(ModContent.TileType<EyeMusicBoxPlaced>(), 0);
    }
}

public class EyeMusicBoxPlaced : ModTile
{
    public override string Texture => "Everware/Assets/Textures/EyeOfCthulhu/EyeMusicBoxPlaced";
    public override void SetStaticDefaults()
    {
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<EyeMusicBox>();
    }
