...
{
    public override string Texture => "Everware/Assets/Textures/EyeOfCthulhu/CthulhuBloodProjectile";
    ...
    {
        var asset = Assets.Textures.EyeOfCthulhu.CthulhuBloodProjectile.Asset;

        var BloodEffect = Assets.Effects.EyeOfCthulhu.CthulhuBloodProjectileEffect.CreateBloodEffect();
        BloodEffect.Parameters.BloodGradient = Assets.Textures.EyeOfCthulhu.BloodProjectilePalette.Asset.Value;
